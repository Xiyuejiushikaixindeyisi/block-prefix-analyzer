"""Plot coverage profile for common-prefix chain analysis (trie-greedy v1.3)."""
from __future__ import annotations

from pathlib import Path

from block_prefix_analyzer.analysis.common_prefix import CommonPrefixChainResult
